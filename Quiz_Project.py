...
sg.set_options(font=("Helvetica", 22))
...
window_background = sg.Window('Background', background_layout, no_titlebar=True,keep_on_top=True, finalize=fin_menu, margins=(0, 0), element_padding=(0,0))

menu    =[[sg.Push(),sg.Text("Sree Narayana Public School Poothotta",font="Verdana 26 italic",pad=(0,(11,0))),sg.Push()],
          [sg.Push(),sg.Text("ComputerScience Department\n",font="Verdana 26 italic"),sg.Push()],
          [sg.Push(),sg.Text("Take A Quiz\n",font="Helvetica 24",pad=(0,0)),sg.Push()],
          [sg.VPush()],
          [sg.Text("Select A Category",font="Helvetica 24",pad=((95,0),0))],
          [sg.Push(),sg.Slider((1,3),orientation="horizontal",size=(12,18),pad=((0,9),0))],
          [sg.Button("MATHS",size=(25,1),pad=((12,0),(0,8))),sg.Push(),sg.Text("Difficulty",font="Helvetica 23",pad=((0,60),0))],
          [sg.Button("COMPUTER SCIENCE",size=(25,1),pad=((12,0),(0,8))),sg.Push()],
          [sg.Button("SCIENCE",size=(25,1),pad=((12,0),(0,8))),sg.Push(),sg.Text("Follow Me On Github",font="Helvetica 23",pad=((0,12),(0,8)))],
          [sg.Button("ENGLISH",size=(25,1),pad=((12,0),(0,8))),sg.Push(),sg.Button("@Solidsilvr",size=(9,1),pad=((0,12),(0,8)))],
          [sg.Button("GK",size=(25,1),pad=((12,0),(0,12))),sg.Push(),sg.Button("QUIT",size=(9,1),pad=((0,12),(0,12)))]
          ]
...
qz_bg_win=sg.Window('qz_Background', qz_bg_lo, no_titlebar=True,keep_on_top=True, finalize=fin_qz, margins=(0, 0), element_padding=(0,0))

qz_lo  =[[sg.Text("Question",pad=((13,0),(11,0)),font="Helvetica 25"),sg.Text(key="QuizNum",pad=((2,0),(11,0)),font="Helvetica 25"),sg.Push(),sg.Text(key="Timer",font="Impact 35",text_color="white",size=(6,1),justification='right',pad=((0,16),(11,0)))],
         [sg.Text(key="-Question-",pad=((13,0),(5,0)),font="Helvetica 24"),sg.Push()],
         [sg.VPush()],
         [sg.Push(),sg.Button(key="A",size=(35,1),pad=((8,5),(0,9))),sg.Button(key="B",size=(35,1),pad=((5,8),(0,9))),sg.Push()],
         [sg.Push(),sg.Button(key="C",size=(35,1),pad=((8,5),(0,9))),sg.Button(key="D",size=(35,1),pad=((5,8),(0,9))),sg.Push()] 
          ]
...
sc_bg_win=sg.Window('sc_Background', sc_bg_lo, no_titlebar=True,keep_on_top=True, finalize=fin_sc, margins=(0, 0), element_padding=(0,0))

sc_lo  =[[sg.VPush()],
         [sg.Push(),sg.Text("Your Score = ",font="Helvetica 28",pad=((5,0),(122,0))),sg.Text(key="-score-",font="Verdana 29 italic",justification='c',pad=((1,3),(122,0))),sg.Text("/",font="Verdana 26 italic",pad=((2,1),(122,0))),sg.Text(key="-Total-",font="Verdana 29 italic",justification='c',pad=((0,5),(122,0))),sg.Push()],
         [sg.Push(),sg.Text("Return To Main Menu",font="Helvetica 25",pad=(0,(1,48))),sg.Push()],
         [sg.Push(),sg.Button("RESET",size=(8,1),pad=(10,(0,162))),sg.Button("QUIT",size=(8,1),pad=(10,(0,162))),sg.Push()]
          ]
...
quit_bg_win=sg.Window('quitsc_Background', quit_bg_lo, no_titlebar=True, finalize=fin_quit, margins=(0, 0), element_padding=(0,0),keep_on_top=True)
