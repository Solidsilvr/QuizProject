...
menu    =[[sg.Push(),sg.Text("Sree Narayana Public School Poothotta"),sg.Push()],
          ...
          [sg.Push(),sg.Slider((1,3),orientation="horizontal",size=(10,12))],
          [sg.Button("MATHS",size=(25,1)),sg.Text("                                                                            Difficulty")],
          [sg.Button("COMPUTER SCIENCE",size=(25,1)),sg.Push()],
          [sg.Button("SCIENCE",size=(25,1)),sg.Push()],
          [sg.Button("ENGLISH",size=(25,1)),sg.Push()],
          [sg.Button("GK",size=(25,1)),sg.Push(),sg.Button("QUIT")]
          ]
...
while True :
    ...
    if event5 == "A":
        ...
        window5.close()
    if sg.popup_yes_no(read, no_titlebar=True) == "Yes":
        break
print("Done")